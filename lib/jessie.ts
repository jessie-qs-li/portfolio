...
- What it does: an AI-powered drawing buddy for kids ages 4 to 6. Children draw on an iPad or laptop while an AI companion watches, listens to the child's voice, and encourages them while asking open-ended questions that prompt more creation. It suggests creative ideas, builds stories around their drawings, and nudges them to add details, turning simple scribbles into imaginative adventures.
- How it was built: a web-based iPad app using React and Fabric.js for the digital canvas. Computer vision analyzes the drawings in real time. ElevenLabs generates the age-appropriate prompts and story suggestions and provides the natural, kid-friendly voice responses. Gemini and FastAPI handle backend processing and the AI interactions.
- Hardest part: designing AI interaction for pre-literate children. Making the responses safe, encouraging, and not overly directive took careful prompt engineering.
- Proud of: it genuinely feels like a creative companion rather than a tool. The AI reacts contextually to what a child is drawing and keeps them engaged without overwhelming them. The team is especially proud of the friendly voice system, and of the fact that the app promotes imagination instead of automating art.
- What they learned: pacing and tone matter enormously when designing AI for children, since too many prompts disrupt creativity while too few reduce engagement. They also got experience integrating multimodal AI, meaning vision, language, and voice, into a seamless real-time application optimized for tablets and laptops.
- What is next: more guided story modes, personalized progress tracking, and collaborative features for parents and teachers. Broader accessibility options and better offline support. And more AI buddies with unique personalities, turning Noodle into a long-term creative learning platform.
