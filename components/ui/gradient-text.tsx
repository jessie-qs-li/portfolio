...
function GradientText({
  ...
  return (
    <MotionComponent
      className={cn("relative overflow-hidden bg-[var(--bg)]", className)}
      {...props}
    >
      {children}
      {/* gradient-text-glow-layer class handles mix-blend-mode per theme via globals.css */}
      <span className="gradient-text-glow-layer pointer-events-none absolute inset-0">
